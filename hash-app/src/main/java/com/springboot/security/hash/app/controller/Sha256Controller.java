...
public class Sha256Controller {
    ...
    public ResponseEntity<String> hashSHA256(@RequestBody DataRequest inputData) {
        return new ResponseEntity<>(hashSha256Service.hashSHA256(inputData.getData()), HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<Boolean> checkMatchSha256(@RequestBody MatchDataRequest inputData) {
        return new ResponseEntity<>(hashSha256Service.isSHA256Match(inputData.getRawData(), inputData.getHashedData()), HttpStatus.OK);
    }
